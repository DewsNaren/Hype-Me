...
//   const profiles = document.querySelectorAll(".profile-container .user-profile");
//   const loginToken = localStorage.getItem("token");
...
//       if (p.classList.contains("default")) p.classList.add("not-active");
//       if (p.classList.contains("active-profile")) p.classList.add("not-active");
//       if (p.classList.contains("login-profile")) 
//           p.textContent = localStorage.getItem("userInitial").toUpperCase();
//     });
//   } else {
//     profiles.forEach(p => {
//       if (p.classList.contains("login-profile")) p.classList.add("not-active");
