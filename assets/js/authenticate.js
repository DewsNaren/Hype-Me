...
const authenticateCloseBtns = document.querySelectorAll(
  ".authenticate-toast-container img"
);
...
async function handleLogin(form) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      enableLogout();
      const updatedProfiles = document.querySelectorAll(
...
const logoutBtn = document.querySelectorAll(
  ".profile-container .profile-menu .logout-btn"
);
...
const logoutContentContainer = logoutModal.querySelector(
  ".logout-modal .logout-content-container"
);
const cancelLogoutBtn = logoutModal.querySelector(".cancel-btn");
const confirmLogoutBtn = logoutModal.querySelector(".confirm-btn");
const logoutSuccessContainer = logoutModal.querySelector(
  ".logout-modal .logout-success-container"
);
const signUpBtn = document.querySelectorAll(
  ".profile-container .profile-menu .signup-btn"
);
const loginBtn = document.querySelector(
  ".profile-container .profile-menu .login-btn"
);

const chatModalWrapper = document.querySelector(".chat-modal-wrapper");
const chatBtns = document.querySelectorAll(
  ".profile-container .profile-menu .chat-btn"
);
...
logoutModalCloseBtn.addEventListener("click", () => {
  ...
  const logoutContentContainer = document.querySelector(".logout-content-container");
  if(logoutContentContainer.classList.contains("not-active")){
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (sessionStorage.getItem("totalReviews")) {
          sessionStorage.removeItem("totalReviews");
        }
        if (sessionStorage.getItem("productSearchResults")) {
          sessionStorage.removeItem("productSearchResults");
        }
        ...
        if (sessionStorage.getItem("savedProducts")) {
...
const forgotBtn = loginContainer.querySelector(
  ".password-group .forgot-link a"
);
